...
public class DbHandler extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
                        ...
                        String CREATE_Payment_TABLE_35 = "CREATE TABLE IF NOT EXISTS `Payment` (  `added` TEXT, `updated` TEXT, `bookDetail` TEXT, `address` TEXT, `phoneNumber` TEXT, `email` TEXT, `amount` NUMBER, `id` TEXT PRIMARY KEY, `bookId` TEXT, `customerId` TEXT, _DATA_UPDATED NUMBER )";
                        ...
                        String CREATE_Order_TABLE_36 = "CREATE TABLE IF NOT EXISTS `Order` (  `added` TEXT, `updated` TEXT, `orderNumber` TEXT, `transactionId` TEXT, `orderStatus` TEXT, `paymentStatus` TEXT, `errorMessage` TEXT, `amount` NUMBER, `type` TEXT, `id` TEXT PRIMARY KEY, `bookId` TEXT, `customerId` TEXT, `paymentId` TEXT, _DATA_UPDATED NUMBER )";
