...
public class DbHandler extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
                        ...
                        String CREATE_Post_TABLE_22 = "CREATE TABLE IF NOT EXISTS `Post` (  `heading` TEXT, `description` TEXT, `added` TEXT, `postImages` TEXT, `anonymous` NUMBER, `status` TEXT, `id` TEXT PRIMARY KEY, `customerId` TEXT, _DATA_UPDATED NUMBER )";
                        ...
                        String CREATE_Comment_TABLE_24 = "CREATE TABLE IF NOT EXISTS `Comment` (  `answer` TEXT, `status` TEXT, `id` TEXT PRIMARY KEY, `postId` TEXT, `customerId` TEXT, _DATA_UPDATED NUMBER )";
                        ...
                        String CREATE_SavePost_TABLE_28 = "CREATE TABLE IF NOT EXISTS `SavePost` (  `added` TEXT, `id` TEXT PRIMARY KEY, `postId` TEXT, `customerId` TEXT, _DATA_UPDATED NUMBER )";
                        db.execSQL(CREATE_SavePost_TABLE_28);


                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                        
                        String CREATE_LikePost_TABLE_29 = "CREATE TABLE IF NOT EXISTS `LikePost` (  `added` TEXT, `id` TEXT PRIMARY KEY, `postId` TEXT, `customerId` TEXT, _DATA_UPDATED NUMBER )";
                        ...
                        String CREATE_Payment_TABLE_35 = "CREATE TABLE IF NOT EXISTS `Payment` (  `bookDetail` TEXT, `address` TEXT, `phoneNumber` TEXT, `email` TEXT, `amount` NUMBER, `id` TEXT PRIMARY KEY, `bookId` TEXT, `customerId` TEXT, _DATA_UPDATED NUMBER )";
                        db.execSQL(CREATE_Payment_TABLE_35);


                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                        
                        String CREATE_Order_TABLE_36 = "CREATE TABLE IF NOT EXISTS `Order` (  `orderNumber` TEXT, `orderStatus` TEXT, `amount` NUMBER, `type` TEXT, `id` TEXT PRIMARY KEY, `bookId` TEXT, `customerId` TEXT, _DATA_UPDATED NUMBER )";
